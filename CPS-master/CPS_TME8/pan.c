...
printm(int x)
{
	...
	case 4: Printf("ACTIF"); break;
	case 5: Printf("INITIALISATION"); break;
	case 6: Printf("PANNE"); break;
	case 7: Printf("CONTINU"); break;
	case 8: Printf("CLIGNOTANT"); break;
	default: Printf("%d", x);
	}
}
void
