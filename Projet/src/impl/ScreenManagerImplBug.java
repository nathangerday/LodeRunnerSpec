...
public class ScreenManagerImplBug implements ScreenManager {

    private List<LevelSetup> levels;

    @Override
    public ScreenManager copy(){
        ScreenManagerImplBug copy = new ScreenManagerImplBug();
    ...
    public void removeScreen(int i) {
        levels.remove(0); //BUG Retire toujours le premier screen
    }
