...
#define _nstates2	9	/* injection_panne */
#define minseq2	54
#define maxseq2	61
#define _endstate2	8

#define _nstates1	18	/* check_light */
#define minseq1	37
#define maxseq1	53
#define _endstate1	17

#define _nstates0	38	/* feu */
#define minseq0	0
#define maxseq0	36
...
#define Pinjection_panne	((P2 *)this)
typedef struct P2 { /* injection_panne */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Pcheck_light	((P1 *)this)
typedef struct P1 { /* check_light */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air1	(sizeof(P1) - Offsetof(P1, e2) - 1*sizeof(uchar))
...
#define Air0	(sizeof(P0) - Offsetof(P0, etat_apres) - 1*sizeof(uchar))
