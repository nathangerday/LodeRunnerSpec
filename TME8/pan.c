...
short src_ln1 [] = {
	  0,  37,  37,  38,  39,  39,  39,  39, 
	 40,  38,  42,  42,  42,  37,  44,  37, 
	 44,  45,  46,  47,  48,  50,  51,  51, 
	 36,  53,  36,  53,   0, };
S_F_MAP src_file1 [] = {
	{ "-", 0, 0 },
	{ "mutex1.pml", 1, 27 },
...
short src_ln0 [] = {
	 ...
	 15,  13,  17,  17,  17,  12,  20,  12, 
	 20,  21,  23,  25,  26,  28,  30,  30, 
	 11,  32,  11,  32,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "mutex1.pml", 1, 27 },
...
iniglobals(int calling_pid)
{
		...
		now.cs_counter = 0;
#ifdef VAR_RANGES
		logval("ask0", now.ask0);
		logval("ask1", now.ask1);
