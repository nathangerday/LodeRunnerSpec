...
short src_ln1 [] = {
	  0,  20,  20,  20,  21,  19,  23,  19, 
	 25,  25,  25,  26,  24,  28,  24,  30, 
	 30,  30,  31,  29,  33,  29,  35,  35, 
	 35,  36,  36,  36,  37,  37,  37,  38, 
	 34,  40,  34,  42,  42,  42,  43,  43, 
	 43,  44,  41,  46,  41,  48,  48,  48, 
	 49,  49,  49,  50,  50,  50,  51,  47, 
	 53,  47,  55,  55,  55,  56,  56,  56, 
	 57,  57,  57,  58,  54,  60,  54,  62, 
	 62,  62,  63,  63,  63,  64,  61,  66, 
	 61,  68,  68,  68,  69,  69,  69,  70, 
	 67,  72,  67,  74,  74,  74,  75,  75, 
	 75,  76,  73,  78,  73,  80,  80,  80, 
	 81,  81,  81,  82,  79,  84,  79,  86, 
	 86,  86,  87,  87,  87,  88,  85,  90, 
	 85,  92,  92,  92,  93,  93,  93,  94, 
	 91,  96,  91,  98,  98,  98,  99,  97, 
	101,  97, 103, 103, 103, 104, 104, 104, 
	105, 102, 107, 102, 109, 109, 109, 110, 
	110, 110, 111, 108, 113, 108, 115, 115, 
	115, 116, 116, 116, 117, 114, 119, 114, 
	121, 121, 121, 122, 120, 124, 120, 126, 
	126, 126, 127, 127, 127, 128, 128, 128, 
	129, 125, 131, 125, 133, 133, 133, 134, 
	134, 134, 135, 132, 137, 132, 139, 139, 
	139, 140, 140, 140, 141, 138, 143, 138, 
	145, 145, 145, 146, 144, 148, 144, 150, 
	150, 150, 151, 151, 151, 149, 154, 149, 
	156, 156,   0, };
S_F_MAP src_file1 [] = {
	{ "-", 0, 0 },
	{ "laby.pml", 1, 225 },
...
{	/* int i; */
	printf("global vars:\n");
	printf("	mtype  NORTH:	5\n");
	printf("	mtype  SOUTH:	4\n");
	printf("	mtype  EAST:	3\n");
	printf("	mtype  WEST:	2\n");
	printf("	mtype  EXIT:	1\n");
...
printm(int x, char *s)
{
	...
	case 2: Printf("WEST"); return;
	case 3: Printf("EAST"); return;
	case 4: Printf("SOUTH"); return;
	case 5: Printf("NORTH"); return;
